...
def colisionando():
    colisionando = False
    if posicion_triangulo[0] + 0.05 >= posicion_cuadrado[0] - 0.05 and posicion_triangulo[0] - 0.05 <= posicion_cuadrado[0] + 0.05 and posicion_triangulo[1] + 0.05 >= posicion_cuadrado[1] - 0.05 and posicion_triangulo[1] - 0.05 <= posicion_cuadrado + 0.05:
        colisionando = True
    return colisionando
